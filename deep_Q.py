...
def train_dqn(num_episodes, grid_size=(5, 5)):
    ...
    env = gym.make("gym-generals-v0", grid_factory=grid_factory, agent=dqn_agent, npc=npc_agent, render_mode="human")
...
if __name__ == "__main__":
    ...
    num_episodes = 20000  # Set the number of episodes you want to train for
